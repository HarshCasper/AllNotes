    ...
    <footer className="footer">
      <div className="row mb-0 mt-0 ">
        ...
        <div className="mb-0 mt-0 col-12 col-md-4 contact">
          ...
          <p></p>
          <li>
            <span className="fa fa-phone fa-lg"></span> 020 88292293
          </li>
          <li>
            <span className="fa fa-envelope fa-lg"></span> mrxyz@gmail.com
          </li>
        </div>
      ...
      <div className="row copyright mb-0 mt-0">
        <p>Copyright © 2021 ALL NOTES : Online Notes Solution</p>
      </div>
    </footer>
  );
}
